...
ItemEvents.modification(event => {
    ...
    event.modify([
        ...
        item.addAttribute("spell_power:fire", "1989c4f4-7685-48b3-a3af-b3c66218d93b", "Iron Penality", - 0.15, "multiply_total")
        item.addAttribute("spell_power:arcane", "1989c4f4-7685-48b3-a3af-b3c66218d93b", "Iron Penality", - 0.15, "multiply_total")   
        item.addAttribute("spell_power:frost", "1989c4f4-7685-48b3-a3af-b3c66218d93b", "Iron Penality", - 0.15, "multiply_total")   
        item.addAttribute("spell_power:healing", "1989c4f4-7685-48b3-a3af-b3c66218d93b", "Iron Penality", - 0.15, "multiply_total")   
        item.addAttribute("arcanuscontinuum:mana_regen", "1989c4f4-7685-48b3-a3af-b3c66218d93b", "Iron Penality", - 0.15, "multiply_total")   
    });
    ...
    event.modify([
        ...
        item.addAttribute("minecraft:generic.movement_speed", "1989c4f4-7685-48b3-a3af-b3c66218d93b", "Iron Penality", - 0.01, "multiply_total")   
